...
function y=tau_eff_HI_exact(z1,z2,E)
global E_prime_g
...
y(i)=dblquad(@tau_exact_func,log(1.e13),log(1.e22),z1,z2(i));
...
function y=tau_exact_func(lgN,z)
global E_prime_g
...
y=N_HI.*fN_single_power_law(N_HI,z).*(1-exp(-N_HI.*sigma_HI(E)));
